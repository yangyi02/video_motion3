...
class Robot128Data(RealData):
    def __init__(self, args):
        super(Robot128Data, self).__init__(args)
        self.name = 'robot128'
        self.train_dir = '/home/yi/code/video_motion_data/robot128-train'
        self.test_dir = '/home/yi/code/video_motion_data/robot128-test'
