...
from synthetic_bidata import SyntheticBiData
...
class BoxDataComplex(SyntheticBiData):
    ...
    def get_next_batch(self, images=None):
        ...
        im, motion, motion_r, motion_label, motion_label_r, seg_layer = self.generate_data(src_image, src_mask, bg_color)
