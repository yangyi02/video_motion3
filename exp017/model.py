...
class Net(nn.Module):
    def __init__(self, im_height, im_width, im_channel, n_inputs, n_class, m_range, m_kernel):
        ...
        num_hidden = 64
        self.conv0 = nn.Conv2d(n_inputs*im_channel, num_hidden, 5, 1, 2)
        self.bn0 = nn.BatchNorm2d(num_hidden)
        self.conv1 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn1 = nn.BatchNorm2d(num_hidden)
        self.conv2 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn2 = nn.BatchNorm2d(num_hidden)
        self.conv3 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn3 = nn.BatchNorm2d(num_hidden)
        self.conv4 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn4 = nn.BatchNorm2d(num_hidden)
        self.conv5 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn5 = nn.BatchNorm2d(num_hidden)
        self.conv6 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn6 = nn.BatchNorm2d(num_hidden)
        self.conv7 = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn7 = nn.BatchNorm2d(num_hidden)
        self.conv8 = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn8 = nn.BatchNorm2d(num_hidden)
        self.conv9 = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn9 = nn.BatchNorm2d(num_hidden)
        self.conv10 = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn10 = nn.BatchNorm2d(num_hidden)
        self.conv11 = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn11 = nn.BatchNorm2d(num_hidden)
        self.conv12 = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn12 = nn.BatchNorm2d(num_hidden)
        self.conv13 = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn13 = nn.BatchNorm2d(num_hidden)
        self.conv = nn.Conv2d(num_hidden, n_class, 5, 1, 2)

        self.conv0_d = nn.Conv2d(im_channel, num_hidden, 5, 1, 2)
        self.bn0_d = nn.BatchNorm2d(num_hidden)
        self.conv1_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn1_d = nn.BatchNorm2d(num_hidden)
        self.conv2_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn2_d = nn.BatchNorm2d(num_hidden)
        self.conv3_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn3_d = nn.BatchNorm2d(num_hidden)
        self.conv4_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn4_d = nn.BatchNorm2d(num_hidden)
        self.conv5_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn5_d = nn.BatchNorm2d(num_hidden)
        self.conv6_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn6_d = nn.BatchNorm2d(num_hidden)
        self.conv7_d = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn7_d = nn.BatchNorm2d(num_hidden)
        self.conv8_d = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn8_d = nn.BatchNorm2d(num_hidden)
        self.conv9_d = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn9_d = nn.BatchNorm2d(num_hidden)
        self.conv10_d = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn10_d = nn.BatchNorm2d(num_hidden)
        self.conv11_d = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn11_d = nn.BatchNorm2d(num_hidden)
        self.conv12_d = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn12_d = nn.BatchNorm2d(num_hidden)
        self.conv13_d = nn.Conv2d(num_hidden * 2, num_hidden, 5, 1, 2)
        self.bn13_d = nn.BatchNorm2d(num_hidden)
        self.conv_d = nn.Conv2d(num_hidden, 3, 5, 1, 2)

        self.conv0_v = nn.Conv2d(n_inputs*im_channel, num_hidden, 5, 1, 2)
        self.bn0_v = nn.BatchNorm2d(num_hidden)
        self.conv1_v = nn.Conv2d(num_hidden, num_hidden, 5, 1, 2)
        self.bn1_v = nn.BatchNorm2d(num_hidden)
        self.conv_v = nn.Conv2d(num_hidden, 3, 5, 1, 2)
